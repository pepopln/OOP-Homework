...
import comparingоbjects.models.PersonImlp;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true){
            ...
            Person currentPerson = new PersonImlp(name,age);

            personList.add(currentPerson);
        }
        int nthPersonInList = Integer.parseInt(reader.readLine());
    ...
    private static void printCounts(int numberOfNotEqualPeople, int numberOfEqualPeople, int totalPeopleCount) {
        if (numberOfEqualPeople==1){
            ...
            System.out.printf("%d %d %d\n",numberOfEqualPeople,numberOfNotEqualPeople,totalPeopleCount);
        }
    }
